    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 60, Math.toRadians(180), Math.toRadians(180), 15).followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(40, 36, Math.toRadians(0.00)))
                                .splineToConstantHeading(new Vector2d(36,12), Math.toRadians(180.00))
                                .splineToConstantHeading(new Vector2d(-52, 12), Math.toRadians(0.00))
                                .setReversed(true)
                                .splineToConstantHeading(new Vector2d(38, 12), Math.toRadians(0.00))
