...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.0519;//1.0300;//1.7666;//1.75199416;//1.73745173745;//1.62162162162;//2.6;//2.07612456747;//1.76470588235;//1.44578313253;//2.10526315789;//1
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.2, 0.2, Math.toRadians(0.5)), 0.75);
