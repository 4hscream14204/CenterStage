...
public class BlueRightAsync extends OpMode {
    ...
    public void init(){
        ...
        LeftSpike = robotBase.mecanumDriveSubsystem.trajectorySequenceBuilder(new Pose2d(-41, 63.3, Math.toRadians(270.00)))
                ...
                .splineToSplineHeading(new Pose2d(-20.00, 12.00, Math.toRadians(0.00)), Math.toRadians(0.00))
                .splineTo(new Vector2d(36.04, 18.00), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(37, 40.5),Math.toRadians(0.00))
                .waitSeconds(2.5)
